...
dataset = UAVVasteDataset(get_transform(train=True))
dataset_test = UAVVasteDataset(get_transform(train=False))
...
# TODO: Fix import
torch.save(model.state_dict(), "/Users/danny/Projects/Side Projects/litgo-detector/mask_rcnn/saved_models/model.pt")
