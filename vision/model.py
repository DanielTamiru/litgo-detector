...
from vision.dataset import AbstractCocoDataset
...
class AbstractLitgoModel:
    model: GeneralizedRCNN
    dataset: AbstractCocoDataset
    ...
    def load_saved_state(self, saved_model_filename: str):
...
class LitgoModel(AbstractLitgoModel):
    model: MaskRCNN
